...
class TrainRequest(BaseModel):
    ...
    formato_visualizacion: str = Field(
        ...,
        description=(
            "Descripción del formato visual deseado para presentar los datos extraídos. "
            "Ejemplo: 'tabla con columnas de producto y precio', 'tarjetas con imagen y descripción', "
...
class ExecuteResponse(BaseModel):
    ...
    componente_react: str = Field(
        ...,
        description="Componente React JSX funcional listo para renderizar los datos extraídos"
    )
    mensaje: str
